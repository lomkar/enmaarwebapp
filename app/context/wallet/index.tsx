"use client";
import { useAlchemyProvider } from "@/app/hooks/useAlchemyProvider";
import { useMagicSigner } from "@/app/hooks/useMagicSigner";
...
export const WalletContextProvider = ({
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setUsername(metadata.email);
      setOwnerAddress(metadata.publicAddress as Address);
      // let getAddress = await provider.getAddress()
      // setScaAddress(getAddress);
    }
    fetchData();
  }, [magic, connectProviderToAccount, signer, provider]);
